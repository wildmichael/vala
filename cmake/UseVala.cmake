...
# ValaConfig.cmake has already been loaded. Refer to ValaConfig.cmake for
# information on how to use Vala in your CMake project.

get_property(_USEVALA_INCLUDED GLOBAL PROPERTY USEVALA_INCLUDED DEFINED)
if(_USEVALA_INCLUDED)
  return()
endif()
set_property(GLOBAL PROPERTY USEVALA_INCLUDED TRUE)
...
function(vala_precompile target outvar)
  ...
  foreach(pkg ${ARGS_PACKAGES})
    # add the package and its dependencies to the list depends
  ...
  foreach(d ${depends})
    if(NOT TARGET ${d})
      list(APPEND vala_pkg_opts "--pkg=${d}")
    endif()
  endforeach()
  ...
  if(ARGS_GENERATE_INTERNAL_VAPI)
    ...
    if(NOT ARGS_GENERATE_HEADER)
      string(REGEX REPLACE "\\.vapi$" ".h" ARGS_GENERATE_HEADER
        "${ARGS_GENERATE_VAPI}")
    endif()
    if(NOT ARGS_GENERATE_INTERNAL_HEADER)
      set(ARGS_GENERATE_INTERNAL_HEADER ${ARGS_GENERATE_HEADER}_internal)
      string(REGEX REPLACE "\\.h$" "_internal\\1" ARGS_GENERATE_INTERNAL_HEADER
    ...
    list(APPEND vapi_arguments "--internal-vapi=${ARGS_GENERATE_INTERNAL_VAPI}")
  endif()
  ...
  if(ARGS_GENERATE_VAPI)
    ...
    list(APPEND vapi_arguments "--vapi=${ARGS_GENERATE_VAPI}")
  endif()
